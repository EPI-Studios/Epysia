...
public enum KeyCode {
    ...
    private static final Map<Integer, KeyCode> BY_GLFW = buildLookup();

    private final int glfwCode;

    KeyCode(int glfwCode) {
    ...
    public static Optional<KeyCode> fromGlfw(int glfwCode) {
        return Optional.ofNullable(BY_GLFW.get(glfwCode));
    }

    private static Map<Integer, KeyCode> buildLookup() {
