...
public final class VoiceService {
    private final Supplier<VoiceConfig> configSource;
    private final Supplier<VoiceRuntime> runtimeSource;
    private final VoiceChannelAssignment channels;

    public VoiceService(Supplier<VoiceConfig> configSource, Supplier<VoiceRuntime> runtimeSource,
                        VoiceChannelAssignment channels) {
